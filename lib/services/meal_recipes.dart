...
abstract final class MealRecipes {
  static const breakfast = <MealRecipe>[
    MealRecipe(
      ...
      [
        ...
        RecipeSlot(RecipeRole.fat, ['Avocado', 'Butter', 'Olive Oil'], required: false),
    ...
    MealRecipe(
      ...
      [
        ...
        RecipeSlot(RecipeRole.fat, ['Almonds', 'Walnuts', 'Chia Seeds'], required: false),
        RecipeSlot(RecipeRole.produce, ['Blueberries', 'Banana'], required: false),
      ],
    ...
    MealRecipe(
      ...
      [
        ...
        RecipeSlot(RecipeRole.produce, ['Spinach', 'Mushrooms', 'Bell Pepper'], required: false),
      ],
    ...
    MealRecipe(
      ...
      [
        ...
        RecipeSlot(RecipeRole.protein, ['Hemp Seeds', 'Pumpkin Seeds', 'Sunflower Seeds']),
        RecipeSlot(RecipeRole.carb, ['Buckwheat', 'Quinoa', 'Oats']),
        RecipeSlot(RecipeRole.produce, ['Blueberries', 'Banana', 'Apple'], required: false),
      ],
  ...
  static const mains = <MealRecipe>[
    MealRecipe(
      ...
      [
        ...
        RecipeSlot(RecipeRole.produce, ['Broccoli', 'Green Beans', 'Carrots'], required: false),
      ],
    ...
    MealRecipe(
      ...
      [
        ...
        RecipeSlot(RecipeRole.fat, ['Olive Oil'], required: false),
        RecipeSlot(RecipeRole.produce, ['Spinach', 'Broccoli'], required: false),
      ],
    ...
    MealRecipe(
      ...
      [
        ...
        RecipeSlot(RecipeRole.produce, ['Bell Pepper', 'Tomato', 'Zucchini'], required: false),
      ],
    ...
    MealRecipe(
      ...
      [
        ...
        RecipeSlot(RecipeRole.fat, ['Olive Oil'], required: false),
        RecipeSlot(RecipeRole.produce, ['Broccoli', 'Bell Pepper', 'Mushrooms'], required: false),
      ],
    ...
    MealRecipe(
      ...
      [
        ...
        RecipeSlot(RecipeRole.fat, ['Olive Oil'], required: false),
        RecipeSlot(RecipeRole.produce, ['Spinach', 'Kale', 'Carrots'], required: false),
      ],
    ...
    MealRecipe(
      ...
      [
        ...
        RecipeSlot(RecipeRole.fat, ['Olive Oil', 'Avocado'], required: false),
        RecipeSlot(RecipeRole.produce, ['Kale', 'Tomato', 'Cucumber'], required: false),
      ],
  ...
  static const snacks = <MealRecipe>[
    ...
    MealRecipe(
      ...
      MealSlotKind.snack,
      [
        RecipeSlot(RecipeRole.protein, ['Pumpkin Seeds', 'Hemp Seeds', 'Sunflower Seeds']),
        RecipeSlot(RecipeRole.produce, ['Apple', 'Banana', 'Orange'], required: false),
      ],
